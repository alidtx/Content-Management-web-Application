	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h5>Menu Add<a class="btn btn-sm btn-success float-right" href="{{route('menu')}}"><i class="fa fa-list"></i> Menu List</a></h5>
			</div>
			<!-- Form Start-->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="name" name="name" value="{{@$editData->name}}" class="form-control" placeholder="Enter Menu Name" >
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('parent') ? 'has-error' : '' }}">
								...
								<select id="parent" name="parent" class="form-control">
									...
									<option value="{{ $pm->id }}" {{ @$editData->parent == $pm->id ? 'selected' : '' }} > {{ $pm->name }} </option>
									@endforeach
								</select>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="url" name="url" value="{{@$editData->route}}" class="form-control" placeholder="Enter Route Name">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="number" id="sort"  value="{{@$editData->sort}}" name="sort" class="form-control" placeholder="Enter Sort Number">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
