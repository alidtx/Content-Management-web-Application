            ...
            $(document).on('click', '.statuschange', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (action == '1') {
                            $.notify("Activate Successfully", {
                                globalPosition: 'top right',
                                className: 'success'
                            });
                        } else {
                            $.notify("Inactive Successfully", {
                                globalPosition: 'top right',
                                className: 'error'
                            });
                        }
                        ...
                        <div class="card" style="margin-bottom: 0px !important;">
                            ...
                            <div id="collapseHomeLink" class="collapse" role="tabpanel"
                                ...
                                <table class="table table-hover" style="margin-bottom: 0;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="linkdata" data-url_type="1" data-id="{{ $homelink->url_link }}"
                            ...
                            <div class="card-header" role="tab" id="headingPostList" style="padding: 0 0;">
                                <h5 class="mb-0">
                                    <a style="display: block;padding: .75rem 1.25rem;"
                                        class="collapsed plusminuscollapse" data-toggle="collapse"
                                        href="#collapsePostList" aria-expanded="false" aria-controls="collapsePostList">
