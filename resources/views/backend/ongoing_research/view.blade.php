            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h5>@lang('Ongoing Research') @lang('List')
                            ...
                            <a class="btn btn-sm btn-primary float-right" href="{{ route('news.ongoing_research.add') }}"
                                style="margin-right: 2px;"><i class="fa fa-plus-circle"></i> @lang('Ongoing Research')
                                @lang('Add')</a>
                        </h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" title="Edit"
                                                href="{{ route('news.ongoing_research.edit', $item->id) }}"><i
