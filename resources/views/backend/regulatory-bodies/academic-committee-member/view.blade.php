...
@section('content')
 ...
 <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">List of Academic Council Member</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h5>Committee Member
            <a class="btn btn-sm btn-success float-right" href="{{ route('academic.committee.member.add') }}"><i class="fa fa-plus-circle"></i> Academic Council Member Add</a>
          </h5>
        </div>
          <div class="card-body">
            <table id="dataTable" class="table table-sm table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{route('academic.committee.member.edit',['id'=>$comitte->id])}}" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
