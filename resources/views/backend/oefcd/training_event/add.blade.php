    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form method="post"  action="{{ !empty($editData) ? route('oefcd.staff.trainer.trainer_update', $editData->id) : route('oefcd.staff.trainer.trainer_store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
