              ...
              <div class="col-md-6">
                <div class="dd" id="nestable" style="width: 100%;">
                  ...
                  <ol class="dd-list new_data">
                    ...
                    <li class="dd-item" data-menu_type_id="{{$id}}" data-rand_id="{{$parent->rand_id}}" data-title_en="{{$parent->title_en}}" data-title_bn="{{$parent->title_bn}}" data-url_link="{{$parent->url_link}}" data-url_link_type="{{$parent->url_link_type}}" data-url_link_file="" data-status="{{$parent->status}}">
