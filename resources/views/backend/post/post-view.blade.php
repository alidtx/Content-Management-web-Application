      ...
      <div class="container-fluid">
        <div class="row">
        	<div class="col-lg-12">
                ...
                <h5 class="m-0 text-dark float-left">Manage Post</h5>
	        			<a href="{{ route('frontend-menu.post.add') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add Post</a>
	        		</div>
		            <div class="card-body">
