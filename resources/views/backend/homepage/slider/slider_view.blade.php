...
<div class="col-xl-12">
  <div class="breadcrumb-holder">
    <h2 class="main-title float-left" style="margin-top: 10px">{{ $category_name->name }}</h2>
          ...
          <table id="" class="table table-sm table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $data->hover_title_1 }}</td>
                  <td>{{ $data->hover_title_2 }}</td>
                ...
                <td>
                  <a class="btn btn-sm btn-success" title="Edit" href="{{ route('homepages.slider.wise.edit',$data->id) }}"><i class="fa fa-edit"></i></a>
