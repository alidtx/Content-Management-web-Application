    ...
    <div class="card">
      <div class="card-header">
        <h5>
          ...
          @endif
          <a class="btn btn-sm btn-success float-right" href="{{route('homepages.news-event.view')}}"><i class="fa fa-list"></i> @lang('Notice and Events') @lang('List')</a></h5>
      </div>
      <!-- Form Start-->
      <form method="post" action="{{(@$editData)?route('homepages.news-event.update',$editData->id):route('homepages.news-event.store')}}" id="myForm" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="form-row">
