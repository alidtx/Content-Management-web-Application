		            ...
		            <div class="card-body">
                      ...
                      <th width="80">Action</th>
                        ...
                        <td>{!!  $p['animation_type']   !!}</td>
		                  	...
		                  	<td><a href="{{ route('site-setting.slider-master.edit',$p->id) }}" class="btn btn-primary btn-flat btn-sm edit" data-type="image" data-id="" data-table="Slider"><i class="fas fa-edit"></i></a> | <a  class="btn btn-danger btn-flat btn-sm" id="delete" data-route = "{{ route('site-setting.slider-master.delete') }}" data-id="{{ $p->id }}" ><i class="fas fa-trash"></i></a>
		                  </td>
		                </tr>
		                @endforeach
		                </tbody>
