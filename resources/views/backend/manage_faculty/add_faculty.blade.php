            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h5>
                        ...
                        @endif
                        <a class="btn btn-sm btn-info float-right" href="{{ route('setup.manage_faculty') }}"><i
                                class="fa fa-list"></i> @lang('Faculty') @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form method="post"
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="faculty_name" type="text" name="name"
                                    class="form-control @error('name') is-invalid @enderror" value="{{ @$editData->name }}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="ucam_faculty_id" type="text" name="ucam_faculty_id"
                                    class="form-control  @error('ucam_faculty_id') is-invalid @enderror"
                                    value="{{ @$editData->ucam_faculty_id }}" placeholder="Ucam Faculty ID">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="contact" type="text" name="contact"
                                    ...
                                    value="{{ @$editData->contact }}" placeholder="">
                                @error('contact')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                <label for="contact">Room No</label>
                                <input id="contact" type="text" name="room_no"
                                    class="form-control  @error('room_no') is-invalid @enderror"
                                    value="{{ @$editData->room_no }}" placeholder="Room No">
                                @error('room_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="sort_order" type="number" name="sort_order"
                                    ...
                                    value="{{ @$editData->sort_order }}" placeholder="">
                                @error('sort_order')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label">Tamplate </label>
                                <select id="tamplate_id" class="form-control form-control-sm select2" name="tamplate">
                                    <option disabled selected value="">Select</option>
                                    <option value="1">Tamplate 1</option>
                                    <option value="2">Tamplate 2</option>
                                </select>
                                @error('tamplate_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="location" type="text" name="location"
                                    ...
                                    value="{{ @$editData->location }}" placeholder="">
                                @error('location')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-sm-12">
                                <label>About</label>
                                <textarea id="about" type="text" class="form-control @error('about') is-invalid @enderror textarea"
                ...
                <div id="dialog-modal">
                    <div class="tmp1">
                        <img src="{{asset('public/frontend/tamplate/tmp1.jpg')}}" id="img1" style="width: 100%" alt="">
                    </div>
                </div>
                <div id="dialog-modal2">
                    <div class="tmp2">
                        <img src="{{asset('public/frontend/tamplate/tmp2.jpg')}}" id="imag1" style="width: 100%" alt="">
                    </div>
                </div>
            </div>
        </div>
