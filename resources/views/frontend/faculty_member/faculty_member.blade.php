    ...
    <section class="container mt-5">
        ...
        <div class="row">
            @foreach ($profiles as $profile)
                <div>
                    <h1 class=" text-secondary text-uppercase fs-3 mb-0 ">{{ @$profile->department->name }}</h1>
                    <div class="mb-0 mt-0 d-inline-block mx-auto" style="width: 30%; background-color: #8b0101; height: 4px">
                    </div>
                </div>
                @php
                    $profile_names = \App\Models\PersonnelsToFaculty::with('profile')
                ...
                @foreach ($profile_names as $name)
                    <div class="col-12 col-md-6 col-lg-3 my-3">
                        <div class="bg-success card rounded-0 member-list-card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('faculty_member.details', $name->id) }}">
